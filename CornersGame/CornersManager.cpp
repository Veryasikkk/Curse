...
bool CornersManager::Start()
{
	...
	std::cout << "Player 1 type (1 - human, another - computer):";
	std::cin >> playerType;
	if (playerType == 1) this->player1 = new CornersHumanPlayer();
	else this->player1 = new CornersComputerPlayer();

	std::cout << "Player 2 type (1 - human, another - computer):";
	std::cin >> playerType;
	if (playerType == 1) this->player2 = new CornersHumanPlayer();
	else this->player2 = new CornersComputerPlayer();
